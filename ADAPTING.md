...
6. **Voice** — replace `references/content/voice-and-tone.md` and `core/VOICE.md` / `core/BRAND_VOICE.md` with yours. Keep `core/DEVELOPER_FLUENCY.md` unless your readers are not developers.
